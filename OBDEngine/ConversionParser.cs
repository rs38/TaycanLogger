...
namespace OBDEngine
{
  ...
  internal class Tokenizer
  {
    ...
    internal double IndexMax { get; private set; }
    ...
    internal void NextToken()
    {
      ...
      if (m_Char == 'B')
      {
        ...
        m_Value = double.Parse(v_StringBuilder.ToString(), CultureInfo.InvariantCulture);
        //we want to know after finished with the expression, what the lenth of the array needs to be...
        IndexMax = Math.Max(IndexMax, m_Value);
        m_Token = Token.Index;
        return;
      }
    }
  ...
  public class ConversionParser
  {
    ...
    public Expression ParseFormula(out int p_IndexMax)
    {
      ...
      p_IndexMax = (int)m_Tokenizer.IndexMax;
      return v_Expression;
    }
